        ...
        <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2.5rem', width: '100%', maxWidth: '960px' }}>
            ...
            <div className="card" style={{ 
              display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '2.5rem 2rem',
              border: '1px solid rgba(37, 211, 102, 0.3)',
              boxShadow: '0 20px 40px rgba(0,0,0,0.6), 0 0 20px rgba(37, 211, 102, 0.15), inset 0 1px 1px rgba(255,255,255,0.1)',
              background: 'linear-gradient(145deg, #111111 0%, #0a1f11 100%)',
              transform: 'translateY(-5px)'
            }}>
              <div style={{ 
                width: '60px', height: '60px', borderRadius: '50%', 
                background: 'linear-gradient(135deg, #25D366 0%, #128C7E 100%)', 
                display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF', marginBottom: '1.25rem',
                boxShadow: '0 10px 20px rgba(37, 211, 102, 0.4), inset 0 2px 4px rgba(255,255,255,0.4)'
              }}>
              ...
              <h4 style={{ fontSize: '1.2rem', marginBottom: '0.75rem', fontFamily: 'var(--font-title)', color: '#FFFFFF', textShadow: '0 2px 4px rgba(0,0,0,0.5)' }}>WhatsApp Oficial</h4>
              <p style={{ fontSize: '0.85rem', color: '#B0B0B0', lineHeight: '1.6', marginBottom: '1.5rem' }}>
              ...
              <a href="https://wa.me/50687378597" target="_blank" rel="noopener noreferrer" className="btn" style={{ 
                width: '100%', fontSize: '0.85rem', padding: '0.8rem', fontWeight: 800,
                background: 'linear-gradient(to bottom, #25D366, #1da851)', color: '#FFFFFF', 
                border: 'none', borderRadius: '8px',
                boxShadow: '0 6px 0 #128C7E, 0 10px 20px rgba(37,211,102,0.4)',
